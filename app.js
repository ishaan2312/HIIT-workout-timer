...
const App = (() => {
            ...
            <div class="exercises-section">
              ...
              <div class="exercises-list" id="exercisesList">
                ${workout.exercises.map((ex, i) => `
                  <div class="exercise-item" draggable="true" data-index="${i}">
  ...
  const setupExerciseDragDrop = () => {
    ...
    exercisesList.addEventListener('dragstart', (e) => {
      ...
      if (e.target.classList.contains('exercise-drag-handle') || e.target.closest('.exercise-item')) {
    ...
    exercisesList.addEventListener('drop', (e) => {
      ...
      const allItems = Array.from(exercisesList.children);
      const draggedIndex = allItems.indexOf(draggedElement);
      
      let target = e.target;
      while (target && !target.classList.contains('exercise-item')) {
        target = target.parentElement;
      }
      
      if (target && target !== draggedElement && target.classList.contains('exercise-item')) {
