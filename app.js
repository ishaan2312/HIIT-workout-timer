...
const App = (() => {
  ...
  const renderHomeScreen = (container) => {
    ...
    const currentWorkout = Storage.getWorkout(currentWorkoutId);
        ...
        <div class="screen-content">
          ${currentWorkout ? `
            <div class="current-workout-card">
              ...
              <button class="btn btn-primary btn-large" data-action="startWorkout">
                Start Workout
              </button>
            </div>
          ` : ''}
  ...
  const updateTimerDisplay = (data) => {
    ...
    if (exerciseName) exerciseName.textContent = data.exerciseName || 'Get Ready';
